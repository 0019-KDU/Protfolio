              ...
              <ul className="hidden md:flex space-x-6 items-center content-center">
                {links.map((link) => (
                  <li
                    ...
                    className={`${
                      isActive(link.href)
                        ? "bg-slate-200 dark:bg-slate-700 rounded-xl shadow-sm"
                        : ""
                    }`}
                  >
                    <Link href={link.href} scroll={false}>
                      <div
                        className={`px-6 text-gray-500 dark:text-gray-300 hover:text-black dark:hover:text-white flex flex-row justify-center cursor-pointer mx-4 max-w-[28px] py-2 ${
                          isActive(link.href)
              ...
              <div className="md:hidden flex items-center">
                ...
                >
                  <svg
                    ...
                    width="30"
                    fill="currentColor"
                    className="bi bi-list mb-1"
                    viewBox="0 0 16 16"
                  >
                    <path
                      fillRule="evenodd"
                      d="M2.5 3.5A.5.5 0 0 1 3 3h10a.5.5 0 0 1 .5.5v.5a.5.5 0 0 1-.5.5H3a.5.5 0 0 1-.5-.5v-.5zM2.5 7.5A.5.5 0 0 1 3 7h10a.5.5 0 0 1 .5.5v.5a.5.5 0 0 1-.5.5H3a.5.5 0 0 1-.5-.5v-.5zM2.5 11.5A.5.5 0 0 1 3 11h10a.5.5 0 0 1 .5.5v.5a.5.5 0 0 1-.5.5H3a.5.5 0 0 1-.5-.5v-.5z"
                    />
                  </svg>
                </motion.div>
                <AnimatePresence>
                      ...
                      {links.map((link, index) => (
                        <Link href={link.href} key={link.href + index}>
                          <motion.div
                            ...
                            className={`text-black dark:text-white text-lg text-center hover:text-orange-500 dark:hover:text-orange-400 cursor-pointer ${
                              isActive(link.href)
